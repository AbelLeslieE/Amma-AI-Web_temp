    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="w-(--sidebar-width) bg-sidebar p-0 text-sidebar-foreground mobile-navigation"
          style={
            {
        ...
        >
          <SheetHeader className="sr-only">
            <SheetTitle>Amma AI navigation</SheetTitle>
            <SheetDescription>
              Choose a page or close the menu to return to your conversation.
            </SheetDescription>
          </SheetHeader>
