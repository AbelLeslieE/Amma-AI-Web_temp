...
const examples = {
  ...
  room: ['ഞാൻ മുറി വൃത്തിയാക്കി', 'room clean cheythu'],
  clothes: ['എന്റെ കറുത്ത ഷർട്ട് എവിടെ', 'black shirt evide'],
  haircut: ['ഞാൻ മുടി മുറിച്ചു', 'new haircut eduthu'],
  gaming: ['ഒരു ഗെയിം കൂടി കളിക്കട്ടെ', 'one more game'],
  gym: ['ഞാൻ ജിമ്മിൽ ചേർന്നു', 'gym-il chernnu'],
  career: ['നാളെ ജോലി ഇന്റർവ്യൂ ഉണ്ട്', 'job interview tomorrow'],
  package: ['എനിക്ക് ഒരു പാക്കേജ് വന്നു', 'package arrived'],
  pet: ['നമുക്ക് ഒരു നായയെ വാങ്ങാമോ', 'can we get a dog'],
  greeting: ['അമ്മേ', 'ഹലോ'],
  thanks: ['അമ്മേ നന്ദി'],
};
